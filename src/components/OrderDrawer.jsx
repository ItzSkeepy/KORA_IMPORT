      ...
      {open && product ? (
        <>
          ...
          <motion.aside
            ...
            className="fixed right-0 top-0 z-50 flex h-screen w-full max-w-lg flex-col border-l border-kora-cream/10 bg-[#0d0b09]/96 p-6 backdrop-blur-xl"
          >
            <div className="flex items-start justify-between">
              <div>
                <p className="gold-kicker">Commande rapide</p>
                <h3 className="mt-4 font-display text-5xl uppercase leading-none">{product.name}</h3>
              </div>
            ...
            <div className="mt-8 rounded-[2rem] border border-kora-gold/15 bg-white/5 p-5">
              <img src={product.images[0]} alt={product.name} className="h-72 w-full rounded-[1.5rem] object-cover" loading="lazy" />
            </div>
            ...
            <div className="mt-8 rounded-[1.75rem] border border-kora-cream/10 bg-black/30 p-5">
              ...
              <p className="mt-2 font-display text-5xl uppercase text-kora-gold">
            ...
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="button-press mt-auto inline-flex items-center justify-center rounded-full bg-kora-gold px-6 py-4 text-sm uppercase tracking-[0.32em] text-black"
            >
